    ...
    majors: [
      {
        ...
        description: "Harvard's Computer Science program combines theoretical foundations with practical applications, preparing students for careers in technology, research, and innovation.",
        ranking: 1,
        duration: "4 years",
        degree: "Bachelor of Science",
        requirements: ["Strong mathematics background", "Programming experience", "AP Computer Science recommended"]
      },
      {
        name: "Business Administration",
        description: "Harvard Business School offers one of the world's most prestigious business programs, focusing on leadership, entrepreneurship, and global business strategy.",
        ranking: 1,
        duration: "2 years",
        degree: "Master of Business Administration",
        requirements: ["Bachelor's degree", "GMAT/GRE scores", "Work experience", "Letters of recommendation"]
      },
      {
        name: "Law",
        description: "Harvard Law School is the oldest continuously operating law school in the United States, offering a comprehensive legal education with global impact.",
        ranking: 1,
        duration: "3 years",
        degree: "Juris Doctor",
        requirements: ["Bachelor's degree", "LSAT scores", "Letters of recommendation", "Personal statement"]
      }
    ]
  },
  {
    ...
    majors: [
      {
        ...
        description: "MIT's EECS program is world-renowned for its cutting-edge research and innovation in electrical engineering and computer science.",
        ranking: 1,
        duration: "4 years",
        degree: "Bachelor of Science",
        requirements: ["Strong mathematics and physics background", "Programming experience", "AP Calculus BC recommended"]
      },
      {
        name: "Mechanical Engineering",
        description: "The Mechanical Engineering program at MIT focuses on design, manufacturing, and mechanical systems, with emphasis on innovation and sustainability.",
        ranking: 1,
        duration: "4 years",
        degree: "Bachelor of Science",
        requirements: ["Strong mathematics and physics background", "Engineering aptitude", "AP Physics recommended"]
      },
      {
        name: "Physics",
        description: "MIT's Physics program is known for its rigorous curriculum and groundbreaking research in theoretical and experimental physics.",
        ranking: 1,
        duration: "4 years",
        degree: "Bachelor of Science",
        requirements: ["Exceptional mathematics skills", "Strong physics background", "Research experience preferred"]
      }
    ]
  },
  {
    ...
    majors: [
      {
        name: "Computer Science",
        description: "Stanford's CS program is at the forefront of technological innovation, with strong ties to Silicon Valley and the tech industry.",
        ranking: 2,
        duration: "4 years",
        degree: "Bachelor of Science",
        requirements: ["Strong mathematics background", "Programming experience", "AP Computer Science recommended"]
      ...
      {
        name: "Engineering",
        description: "Stanford's School of Engineering offers a comprehensive engineering education with emphasis on innovation and entrepreneurship.",
        ranking: 2,
        duration: "4 years",
        degree: "Bachelor of Science",
        requirements: ["Strong mathematics and physics background", "Engineering aptitude", "AP Calculus and Physics recommended"]
      },
      {
        name: "Business",
        description: "Stanford Graduate School of Business is known for its innovative approach to business education and strong entrepreneurial focus.",
        ranking: 2,
        duration: "2 years",
        degree: "Master of Business Administration",
        requirements: ["Bachelor's degree", "GMAT/GRE scores", "Work experience", "Letters of recommendation"]
